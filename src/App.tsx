      ...
      <main className="page-shell">
        ...
        <section className="auth-card success-card">
          ...
          <p className="small-note">
            Prototype mode — your account is being simulated for this demo.
          </p>
        </section>
      </main>
    );
    ...
    return (
      <main className="page-shell">
        ...
        <section className="auth-card success-card">
          ...
          <div className="success-icon">✓</div>
          <p className="eyebrow">ACCOUNT CREATED</p>
          <h1>Welcome to Buka, {form.fullName.split(" ")[0]}! ♡</h1>
          <p className="subtitle">
            Your account is ready. Next, we'll help you set up your business
            and get your Buka workspace ready.
          </p>
          ...
          <p className="small-note">
            Prototype only — no account has been saved to a database yet.
          </p>
        </section>
      </main>
    );
    ...
    <main className="page-shell">
      ...
      <section className="left-panel">
        ...
        <div className="hero-copy">
          ...
          <p>
            Track sales, expenses, customers and money in one lovely little
            place — without needing to be an accountant.
          </p>

          <div className="feature-list">
            <div>
              <span>♡</span>
              <p><strong>Know your numbers.</strong><br />See what you sold, spent and made.</p>
            </div>
            <div>
              <span>✦</span>
              <p><strong>Stay organised.</strong><br />Keep invoices, receipts and customers together.</p>
            </div>
            <div>
              <span>✓</span>
              <p><strong>Built for everyday business.</strong><br />Cash, M-Pesa, EcoCash and bank payments.</p>
            </div>
          </div>
        </div>
      ...
      <section className="form-panel">
        <div className="form-wrap">
          ...
          <div className="form-heading">
            <p className="eyebrow">LET'S GET STARTED</p>
            <h1>Create your account</h1>
            <p>Start with your details. We'll set up your business next.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <label className="terms-row">
              ...
              />
              <span>
                I agree to Buka's <a href="#" onClick={(e) => e.preventDefault()}>Terms</a>{" "}
          ...
          <button className="google-button" type="button" onClick={() => alert("Google sign-up will be connected later.")}>
            <span className="google-icon">G</span>
            Continue with Google
          </button>

          <p className="login-link">
            Already have an account? <a href="#" onClick={(e) => e.preventDefault()}>Log in</a>
          </p>

          <p className="security-note">🔒 Your information is kept secure.</p>
        </div>
      </section>
    </main>
  );
